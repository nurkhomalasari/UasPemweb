            ...
            <table class="table table-stripped">
                ...
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <p>
                            <a class="btn btn-primary" href="<?= base_url('booking/tambahBooking/' . $id); ?>"><i class="fas fw fa-shopping-cart"></i> Booking</a>
                            <span class="btn btn-light" onclick="window.history.go(-1)"><i class="fas fw fa-reply"></i> Kembali</span>
                        </p>
                    </td>
                </tr>
            </table>
