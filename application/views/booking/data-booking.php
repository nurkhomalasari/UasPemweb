            ...
            <table class="table table-bordered table-striped table-hover" id="table-datatable">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('booking/hapusbooking/' . $t['id_buku']); ?>" onclick="return_konfirm('Yakin tidak Jadi Booking '.$t ['judul_buku'])"><i class="btn btn-sm btn-danger fas fw fa-trash"></i></a>
                        </td>
                    </tr>
                <?php 
                $no++;
